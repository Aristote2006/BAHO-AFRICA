...
const WhatWeDoPage = () => {
  const services = [
    ...
    },
    {
      ...
      image: "https://source.unsplash.com/600x400/?heritage,culture"
    },
    {
    ...
    },
    {
      ...
      image: "https://source.unsplash.com/600x400/?network,community"
    }
  ];
    ...
    <div>
      ...
      <Box 
        sx={{ 
          ...
          background: 'linear-gradient(rgba(13, 27, 42, 0.8), rgba(13, 27, 42, 0.8)), url(https://source.unsplash.com/1600x900/?african-arts,culture) center/cover no-repeat',
          color: 'white',
          textAlign: 'center'
        }}
      >
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
            ...
            <Grid item xs={12} md={6} key={index}>
              <StyledCard className="glass-effect">
                ...
                <CardContent sx={{ flexGrow: 1 }}>
                  <Typography gutterBottom variant="h4" component="h3" className="text-fade-in-up" style={{ animationDelay: '0.2s' }} sx={{ color: '#0D1B2A', fontWeight: 600 }}>
                    {service.title}
                  </Typography>
                  <Typography variant="body1" className="text-fade-in-up" style={{ animationDelay: '0.3s' }} sx={{ color: '#5D5D5D', lineHeight: 1.8 }}>
                    {service.description}
                  </Typography>
                </CardContent>
              </StyledCard>
        ...
        <Box sx={{ mt: 10, textAlign: 'center' }}>
          <Typography variant="h3" component="h2" className="text-fade-in-up" style={{ animationDelay: '0.1s' }} gutterBottom sx={{ color: '#0D1B2A', fontWeight: 600, mb: 4 }}>
            Our Approach
          </Typography>
          <Grid container spacing={4}>
            <Grid item xs={12} md={4}>
              <Paper className="glass-effect" elevation={3} sx={{ p: 4, borderRadius: 2, height: '100%', border: '1px solid rgba(255,255,255,0.2)' }}>
                ...
                <Typography variant="body1" className="text-fade-in-up" style={{ animationDelay: '0.3s' }} sx={{ color: '#5D5D5D' }}>
