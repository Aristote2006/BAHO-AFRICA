    ...
    <div>
      ...
      <Box 
        sx={{ 
          ...
          background: 'linear-gradient(rgba(13, 27, 42, 0.8), rgba(13, 27, 42, 0.8)), url(https://source.unsplash.com/1600x900/?contact,african-community) center/cover no-repeat',
          color: 'white',
          textAlign: 'center'
        }}
      >
        ...
        <Grid container spacing={6}>
          ...
          <Grid item xs={12} md={5}>
            <StyledPaper elevation={3}>
              <Typography variant="h4" component="h2" className="text-fade-in-up" style={{ animationDelay: '0.1s' }} gutterBottom sx={{ color: '#0D1B2A', fontWeight: 600, mb: 4 }}>
                Contact Information
              </Typography>
              ...
              <Box className="text-fade-in-up" style={{ animationDelay: '0.2s' }} sx={{ mb: 3 }}>
                ...
                <Typography variant="body1" sx={{ color: '#5D5D5D' }}>
