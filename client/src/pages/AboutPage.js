    ...
    <div>
      ...
      <Box 
        sx={{ 
          ...
          background: 'linear-gradient(rgba(13, 27, 42, 0.8), rgba(13, 27, 42, 0.8)), url(https://source.unsplash.com/1600x900/?african-culture,heritage) center/cover no-repeat',
          color: 'white',
          textAlign: 'center'
        }}
      >
        ...
        <Grid container spacing={6} alignItems="center">
          <Grid item xs={12} md={6}>
            <StyledPaper elevation={3}>
              <Typography variant="h3" component="h2" className="text-slide-in-left" style={{ animationDelay: '0.1s' }} gutterBottom sx={{ color: '#0D1B2A', fontWeight: 600 }}>
                Our Story
              </Typography>
              <Typography variant="body1" className="text-slide-in-left" style={{ animationDelay: '0.2s' }} paragraph sx={{ color: '#5D5D5D', lineHeight: 1.8 }}>
          ...
          <Grid item xs={12} md={6}>
            <Paper 
              ...
              sx={{ 
                height: '400px', 
                backgroundImage: 'url(https://source.unsplash.com/1600x900/?african-artist,creative)',
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={6}>
              <StyledPaper elevation={3}>
                ...
                <Typography variant="body1" className="text-fade-in-up" style={{ animationDelay: '0.3s' }} paragraph sx={{ color: '#5D5D5D', lineHeight: 1.8 }}>
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} sm={6} md={3}>
              <StyledPaper elevation={3} sx={{ textAlign: 'center', py: 4, px: 2, height: '100%' }}>
                ...
                <Typography variant="body2" className="text-fade-in-up" style={{ animationDelay: '0.3s' }} sx={{ color: '#5D5D5D' }}>
